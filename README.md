...
Decision: Fargate
Justification:
I chose AWS Fargate over EC2 to minimize operational overhead. By moving to a serverless container model, I eliminated the need for manual managing, patching, and scaling of underlying EC2 instances, allowing me to focus entirely on application architecture.
